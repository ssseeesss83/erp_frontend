...
import VoucherView from "@/views/gm/VoucherView";
import AnnualBonusView from "@/views/gm/AnnualBonusView";
...
const AccountManagement = () => import("../views/financial/AccountManagement");
const BusinessView = () => import("../views/financial/BusinessView");
const DetailSaleView = () => import("../views/financial/SaleDetailView");
const PayableView = () => import("../views/financial/PayableView");
const ReceiveView = () => import("../views/financial/ReceiveView");
const SalaryView = () => import("../views/financial/SalaryView");
const BusinessConditionView = () => import("../views/financial/BusinessConditionView");
const ClockView = () => import("../views/hr/ClockView");
const EmployeeView = () => import("../views/hr/EmployeeView");
const SalarySystemView = () => import("../views/hr/SalarySystemView");
...
const routes = [
  ...
  {
    path:PATH.BUSINESS_VIEW.path,
    component:BusinessView,
    name:"BusinessView",
    meta: { requiresAuth: PATH.BUSINESS_VIEW.requiresAuth }
  },
  {
    path:PATH.DETAIL_SALE_VIEW.path,
    component:DetailSaleView,
    name:"DetailSaleView",
    meta: { requiresAuth: PATH.DETAIL_SALE_VIEW.requiresAuth }
  },
  {
  ...
  },
  {
    ...
    //人力资源管理
  {
    path:PATH.CLOCK_VIEW.path,
    component:ClockView,
    name:"ClockView",
    meta: { requiresAuth: PATH.CLOCK_VIEW.requiresAuth }
  },
  {
  ...
  {
    path:PATH.SALARY_SYSTEM_VIEW.path,
    component:SalarySystemView,
    name:"SalarySystemView",
    meta: { requiresAuth: PATH.SALARY_SYSTEM_VIEW.requiresAuth }
  },
  {
    path:PATH.VOUCHER_VIEW.path,
    component:VoucherView,
    name:"VoucherView",
    meta: { requiresAuth: PATH.VOUCHER_VIEW.requiresAuth }
  },
  {
    path:PATH.ANNUAL_BONUS_VIEW.path,
    component:AnnualBonusView,
    name:"AnnualBonusView",
    meta: { requiresAuth: PATH.ANNUAL_BONUS_VIEW.requiresAuth }
  },
