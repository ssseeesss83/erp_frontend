...
import { getWarehouseCounting,exportExcel,directDownload} from "@/network/warehouse";
...
export default {
  ...
  methods: {
    exportAsExcel() {
      ...
      //   const bdata = new Blob([res], {'application/vnd.ms-excel'});
      //   console.log(res)
      //   bdata.push(res);
      //   let blobUrl = window.URL.createObjectURL(new Blob(bdata));
